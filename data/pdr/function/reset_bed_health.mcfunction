execute as @a[predicate=pdr:world/morning_time] run attribute @s minecraft:max_health modifier remove pdr_1
execute as @a[predicate=pdr:world/morning_time] run attribute @s minecraft:max_health modifier remove pdr_2
execute as @a[predicate=pdr:world/morning_time] run attribute @s minecraft:max_health modifier remove pdr_3
execute as @a[predicate=pdr:world/morning_time] run attribute @s minecraft:max_health modifier remove pdr_4
execute as @a[predicate=pdr:world/morning_time] run attribute @s minecraft:max_health modifier remove pdr_5
