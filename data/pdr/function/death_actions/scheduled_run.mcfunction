...
execute as @a if score @s pdr.lost.health.counter matches 1 run attribute @s minecraft:generic.max_health modifier add pdr_1 -2 add_value
execute as @a if score @s pdr.lost.health.counter matches 2 run attribute @s minecraft:generic.max_health modifier add pdr_2 -4 add_value
execute as @a if score @s pdr.lost.health.counter matches 3 run attribute @s minecraft:generic.max_health modifier add pdr_3 -6 add_value
